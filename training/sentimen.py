...
try:
    ...
    print(
        ...
        "Pastikan file dataset berada pada folder yang benar."
    )
    raise SystemExit
...
try:
    ...
    print(
        f"Prediksi sentimen test berhasil disimpan "
        f"ke file '{nama_file_hasil}'"
    )
    ...
    print(
        f"Terjadi kesalahan pada proses data test: {e}"
    )
